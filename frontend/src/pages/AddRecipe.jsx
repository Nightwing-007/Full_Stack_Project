            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-8">
                ...
                <div>
                  ...
                  {/* Live Image Preview */}
                  {formData.imageUrl && (
                      <div className="mt-4 rounded-2xl overflow-hidden border border-gray-100 h-48 relative bg-gray-50 flex items-center justify-center">
                        <img
                        ...
                        />
                        <span className="text-gray-400 font-medium text-sm hidden absolute">Image preview unavailable</span>
                      </div>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                    ...
                    disabled={formData.ingredients[formData.ingredients.length - 1]?.trim() === ''}
                    className="disabled:opacity-50 disabled:cursor-not-allowed bg-orange-50 text-orange-600 px-6 py-2.5 rounded-xl font-bold hover:bg-orange-100 transition-colors flex items-center"
                >
